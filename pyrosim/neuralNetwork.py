...
class NEURAL_NETWORK: 
    ...
    def Update(self):
        """
        Main method responsible for updating sesnor/motor neurons.
        """
    ...
    def Is_Motor_Neuron(self, neuron_name: str) -> bool:
        return self.neurons.get(neuron_name).Is_Motor_Neuron()
    
    def Get_Motor_Neuron_Joint(self, neuron_name: str) -> str:
        return self.neurons.get(neuron_name).Get_Joint_Name()
    
    def Get_Value_Of(self, neuron_name: str) -> str:
        return self.neurons.get(neuron_name).Get_Value()
